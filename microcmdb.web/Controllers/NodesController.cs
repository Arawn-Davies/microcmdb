...
namespace microcmdb.web.Controllers
{
    public class NodesController : Controller
    {
        ...
        // Populate the ViewBag with the ConfigItems
        private async Task PopulateVB()
        {
            var configItems = await _context.ConfigItems.ToListAsync();
            ViewBag.ConfigItems = configItems;
        }
        ...
        public async Task<IActionResult> Create([Bind("NodeID,Name,OS_Version,CPU_Arch,RAM,Storage,IPaddr")] Node node)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NodeID,Name,OS_Version,CPU_Arch,RAM,Storage,IPaddr")] Node node)
        {
            if (id != node.NodeID)
            {
                return NotFound();
